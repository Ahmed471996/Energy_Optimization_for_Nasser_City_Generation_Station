...
% Optimization
opts = gaoptimset('PopulationSize',pop_size,'Elitecount',pop_size*0.05,...
    'PopInitRange',[-2500000;2500000],'Generations',G_size,'StallGenLimit',...
    ceil(G_size/2),'StallTimeLimit',inf,'InitialPopulation',[],...
    'display','diagnose','CrossoverFraction',0.6,...
...
var(2) = floor (var(2));                    %round to nearest lower integer
var(3) = ceil (var(3));
